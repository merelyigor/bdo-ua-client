<p align="center">
  <img src="assets/bdo-ua-icon.png" alt="Хаб українізаторів" width="180">
</p>

<h1 align="center">Хаб українізаторів</h1>

<p align="center">
  Windows-хаб для українських локалізацій ігор
</p>
...
Звичайне натискання **X** ховає **Хаб українізаторів** у системний трей, не завершуючи програму. Меню іконки трея містить **"Відкрити"**, **"Перевірити зараз"**, **"Запускати разом із Windows"** і **"Вихід"**. Подвійний клік по іконці відновлює застосунок, а **"Вихід"** повністю завершує його.
...
Фоновий режим розрахований на роботу без помітного навантаження на комп’ютер. На наведеному вимірюванні в Диспетчері завдань Хаб українізаторів споживає **0% CPU**, близько **17,6 МБ оперативної пам’яті**, а активність диска та мережі становить **0 Мбіт/с**. Фактичні показники можуть трохи відрізнятися залежно від системи та моменту перевірки, але застосунок виконує фоновий моніторинг ощадливо й не заважає повсякденній роботі.

![Хаб українізаторів у фоновому режимі — споживання ресурсів](docs/img/background-resource-usage.png)
...
Хаб українізаторів наразі не підписаний комерційним сертифікатом підпису коду (code-signing certificate). Тому Windows SmartScreen може показати попередження **"Невідомий видавець"** при першому запуску.
...
## Як видалити Хаб українізаторів

Хаб українізаторів — portable-застосунок: він не встановлюється у Windows через MSI/MSIX або Windows Installer, тому окремого деінсталятора у **Programs and Features** немає. Для сумісності поточний виконуваний файл зберігає технічну назву **`BDO-UA-Client.exe`**.
