...
| [§35](#35--заборони) | 🚫 Заборони | Що не можна |
| [§36](#36--правило-сумнівів) | 🤔 Правило сумнівів | Надійність > швидкість |
| [§37](#37--головний-принцип) | 💎 Головний принцип | Головне правило |
...
§35.1 Видаляти великі частини проєкту.

§35.2 Змінювати framework/architecture/API contract.

§35.3 Оновлювати всі dependencies.

§35.4 Форматувати весь repository.

§35.5 Відключати security/TLS.

§35.6 Приховувати помилки.

---

## §36 🤔 Правило сумнівів

§36.1 Між швидким-небезпечним та складнішим-надійним — обирати надійне. Особливо для game files, backup, rollback, download validation, path handling.

---

## §37 💎 Головний принцип

§37.1 Користувач запускає → знаходить гру → вибирає локалізацію → встановлює без розуміння internals.

§37.2 **Ніколи не залишати гру у пошкодженому стані заради "успішної" операції.**
