...
<!-- Необов'язковий вступ про цей реліз -->
...
- <!-- опис покращень надійності -->

## Продуктивність

- <!-- опис покращень продуктивності -->

## Зміни

- <!-- технічні зміни, оновлення, рефакторинг -->
...
- <!-- якщо є, інакше видаліть цю секцію -->
...
<!-- Порожні public sections можна опускати. Цей template не є джерелом pending fragments. -->
