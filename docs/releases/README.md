...
- Дочекайтеся завершення: Restore → Build → Test → Publish → Package → Tag
...
- Відредагуйте реліз-нотатки (використовуйте `RELEASE_TEMPLATE.md`)
...
### 5. Політика невдалих кандидатів
