...
> **Source:** commit `ef76c21` (v12.1)
> **Потрібне оновлення:** відобразити поточний стан (dynamic modes, одна кнопка "Встановити", single-file EXE, 313 тестів). Прибрати застарілі пункти (Оновити, Відновити копію, hardcoded modes).
...
Застосунок працює разом з [проектом українізації BDO](https://bdo-ua.com.ua/) та отримує актуальні релізації локалізації через API.
