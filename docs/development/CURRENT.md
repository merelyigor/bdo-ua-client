...
1. C.3 Localization extraction — перенести localization/mode/state/feed методи у `MainForm.Localization.cs` (physical partial, без зміни поведінки).
